...
prepare = async (): Promise<void> => {
	...
	} else if (currentURL.hostname === "phabricator.miraheze.org" ) {
	...
	} else if (currentURL.hostname === "blog.miraheze.org") {
		presenceData.smallImageKey = "phabricator"
	...
	} else if (currentURL.hostname === "donate.miraheze.org") {
	...
	} else if (currentURL.hostname === "status.miraheze.wiki") {

		presenceData.details = "Viewing the status page"
		if (document.title !== "Status Page - Miraheze") presenceData.state = document.title.replace(" - Status Page - Miraheze", "")
